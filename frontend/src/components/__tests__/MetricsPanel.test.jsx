...
describe('MetricsPanel', () => {
  it('filters by file path and highlights critical rows', async () => {
    ...
    // MetricsPanel marks "critical" when a file is strictly above the p90 threshold
    // for both complexity_score and incoming_count. With too few nodes, p90 can equal
    // the max value and nothing will be > p90, so we seed enough low-signal nodes.
    const nodes = [
